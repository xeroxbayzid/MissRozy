...
class Config(object):
	...
	BOT_TOKEN = os.environ.get("BOT_TOKEN","7843173732:AAEDXoQcoqSzUr0Xx-e2lPu6BCsYsF6PJ6o")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "BayzidTest2Bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002172515270))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "5548923721"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://bayzidpremium:bayzidpremium@cluster0.dm24s.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002172515270")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002172515270")
	BANNED_USERS = set(int(x) for x in os.environ.get("BANNED_USERS", "1234567890").split())
	FORWARD_AS_COPY = bool(os.environ.get("FORWARD_AS_COPY", True))
	BROADCAST_AS_COPY = bool(os.environ.get("BROADCAST_AS_COPY", False))
	LAZY_CHANNEL = int(os.environ.get('LAZY_CHANNEL','-1002201154798'))
